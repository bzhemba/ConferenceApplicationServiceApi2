...
internal sealed class
    GetApplicationsByDateQueryHandler : IQueryHandler<GetApplicationsByDateQuery, IEnumerable<ApplicationDto>>
{
    private readonly DbSet<ApplicationReadModel> _applications;

    public GetApplicationsByDateQueryHandler(ReadDbContext context)
    {
