...
internal sealed class GetUnsubmittedApplicationByUserIdHandler: IQueryHandler<GetApplicationByUserIdQuery, ApplicationDto>
{
    private readonly DbSet<ApplicationReadModel> _applications;

    public GetUnsubmittedApplicationByUserIdHandler(ReadDbContext context)
    {
